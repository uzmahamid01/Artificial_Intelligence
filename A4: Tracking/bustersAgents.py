...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        #most likely position of each remaining uncaptured ghost
        for ghostBelief in livingGhostPositionDistributions:
            most_likely_position = ghostBelief.argMax()
            for action in legal:
                successorPosition = Actions.getSuccessor(pacmanPosition, action)
                distance = self.distancer.getDistance(successorPosition, most_likely_position)
